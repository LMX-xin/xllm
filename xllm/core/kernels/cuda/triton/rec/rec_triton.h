...
//                            1] float sm_scale, // 去掉 uint32_t step)
//                            override;

//   void prefill_reshape_and_cache(torch::Tensor proj_k,          //
...
//                                  max_decode_step, head_dim] torch::Tensor
//                                  unshared_v_cache,   // [max_num_request,
//                                  beam_size, kv_heads, max_decode_step,
//                                  head_dim] torch::Tensor block_table,
