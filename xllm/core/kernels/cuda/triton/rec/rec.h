...
class RecKernel {
 public:
  virtual torch::Tensor xattention(
  ...
  virtual void prefill_reshape_and_cache(
      torch::Tensor proj_k,  // [shared_len, kv_heads, head_dim]
      torch::Tensor proj_v,  // [shared_len, kv_heads, head_dim]
      torch::Tensor
          shared_k_cache,  // [num_shared_kv_seq_len, kv_heads, head_dim]
      torch::Tensor
          shared_v_cache) = 0;  // [batch_size + 1], cumulative sequence lengths

  virtual void decoder_reshape_and_cache(
