...
// torch::Tensor RecTritonKernel::xattention(torch::Tensor q, // [batch_size,
// beam_size, num_heads, head_dim]
//                                          torch::Tensor shared_k_cache, //
//                                          [num_shared_kv_seq_len, kv_heads,
//                                          head_dim] torch::Tensor
//                                          shared_v_cache,       //
//                                          [num_shared_kv_seq_len, kv_heads,
//                                          head_dim] torch::Tensor
//                                          unshared_k_cache,     //
//                                          [max_num_request, beam_size,
//                                          kv_heads, max_decode_step, head_dim]
//                                          torch::Tensor unshared_v_cache, //
//                                          [max_num_request, beam_size,
//                                          kv_heads, max_decode_step, head_dim]
//                                          torch::Tensor kv_seq_len, //
//                                          [batch_size] torch::Tensor
//                                          block_table,          //
//                                          [total_beams] float sm_scale,
//                                          uint32_t step) {
//   LOG(FATAL) << "gpu xattention is not implemented by torch.";

// }

// void RecTritonKernel::prefill_reshape_and_cache(torch::Tensor proj_k, //
// [shared_len, kv_heads, head_dim]
//                                                torch::Tensor proj_v, //
//                                                [shared_len, kv_heads,
//                                                head_dim] torch::Tensor
//                                                shared_k_cache,  //
//                                                [num_shared_kv_seq_len,
//                                                kv_heads, head_dim]
...
// void RecTritonKernel::decoder_reshape_and_cache(torch::Tensor proj_k, //
// [batch_size, beam_size, kv_heads, head_dim]
//                                                torch::Tensor proj_v, //
...
//                                                head_dim] torch::Tensor
//                                                block_table,     //
//                                                [batch_size, 1] uint32_t step)
//                                                {
//   // 维度检查
//   LOG(FATAL) << "gpu decoder_reshape_and_cache is not implemented by torch.";
// }

// void RecTritonKernel::beam_search(torch::Tensor acc_logprob,              //
// [B*BEAM_SIZE, 1]
//                                   torch::Tensor in_sequence_group,        //
//                                   [B, BEAM_SIZE, MAX_DECODE_STEP] (Read)
//                                   torch::Tensor top_tokens,               //
//                                   [B*BEAM_SIZE, TOP_K] torch::Tensor
//                                   top_logprobs,             // [B*BEAM_SIZE,
//                                   TOP_K] torch::Tensor out_acc_logprob, //
//                                   [B*BEAM_SIZE, 1] torch::Tensor
//                                   out_token_ids,            // [B*BEAM_SIZE,
//                                   1] torch::Tensor out_token_index, //
//                                   [B*BEAM_SIZE, 1] torch::Tensor
//                                   out_beam_count_prefix_sums, //
//                                   [B*BEAM_SIZE, 1] torch::Tensor
//                                   out_sequence_group,       // [B, BEAM_SIZE,
//                                   MAX_DECODE_STEP] (Write) uint32_t
//                                   batch_size, uint32_t current_step) {
...
//     }
//     default: {
//       LOG(FATAL) << "RecTritonKernel: beam_search_kernel get upsupported
//       dtype "
//                  << top_logprobs.scalar_type();
//       break;
//     }
//   }
//   LOG(INFO) << "beam_search_shared_mem_bytes: " <<
//   beam_search_shared_mem_bytes;
...
//   CHECK_EQ(in_sequence_group.dim(), 3) << "in_sequence_group.dim() must be
//   equal with 3.";
